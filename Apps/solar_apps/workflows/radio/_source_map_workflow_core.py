"""Private core implementation for source_map_workflow.py.
...
import solar_apps.workflows.radio.source_map_workflow as _facade  # noqa: E402
...
def _build_multi_band_slots(cfg: dict) -> list:
    ...
    for freq in freqs:
        if combine_polarizations and polarization == "RR+LL":
            ...
            rr_files = _facade._sorted_fits_for_band(
                rr_dir, start_idx, end_idx, study_mode=cfg.get("study_mode")
            )
            ll_files = _facade._sorted_fits_for_band(
            ...
            files = _facade._sorted_fits_for_band(
