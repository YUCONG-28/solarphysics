"""Private core implementation for overlay_workflow.py.

The public facade lives in the parent module and re-exports this module's
entire namespace; no behavior change.
"""
